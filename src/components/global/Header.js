    ...
    <header className="px-6 py-4 bg-white shadow-md md:px-16 px-2">
      ...
      <div className="hidden md:flex justify-between items-center">
        <a
          ...
          className="btn bg-white hover:bg-white outline-none  border-none text-xl font-thin text-[#2d2d2d]"
        >
          Campus Edge
        </a>
      ...
      <div className="md:hidden flex justify-between items-center">
        <a href="https://campusedge.vercel.app/" className="text-xl font-bold text-[#111827]">
          Campus Edge
        </a>
