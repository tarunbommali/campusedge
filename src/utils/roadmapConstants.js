export const ROADMAPS_LIST = [
  ...
  },
  {
    ...
    resources: [
      ...
      {
        type: "free",
        url: "https://www.youtube.com/playlist?list=PLeo1K3hjS3uset9zIVzJWqplaWBiacTEU",
        step: 2,
      },
      {
        type: "free",
      ...
      {
        type: "free",
        url: "https://youtube.com/playlist?list=PLeo1K3hjS3uvCeTYTeyfe0-rN5r8zn9rw",
        step: 6,
      },
    ],
    path: [
      { step1: "Learn Python" },
      { step2: "Learn Data Analysis & Visualization" },
      { step3: "Learn Statistics & Probability" },
      { step4: "Practice Exploratory Data Analysis" },
      { step5: "Learn SQL" },
      { step6: "Learn Machine Learning" },
      { step7: "Complete ML Projects with Deployment" },
      { step8: "Learn Deep Learning" },
      { step9: "Choose NLP or Computer Vision" },
    ],
  },
  {
